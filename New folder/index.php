...
<div id="container">
  ...
  <input type="text" name="songinput" id="songinputid" value="<?php if(isset($_GET['songinput'])) echo $usersearch;?>">
  <input type="submit" name="songsubmit" id="songsubmitid" value="Search song">
